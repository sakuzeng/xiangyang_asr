...
# 路径配置
data_root="/home/devuser/workspace/asr/dataset/grid_device_finetune/audio_data_2"
...
init_param="/home/devuser/workspace/asr/FunASR-main/examples/industrial_data_pretraining/sense_voice/outputs/sensevoice_finetune_v3/model.pt.best"

# 输出目录改为 v3
output_dir="./outputs/sensevoice_finetune_v4"
mkdir -p ${output_dir}
