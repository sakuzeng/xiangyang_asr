...
async def lifespan(app: FastAPI):
    ...
    # 指定本地模型路径
    local_model_dir = os.path.expanduser("/home/devuser/workspace/asr/FunASR-main/examples/industrial_data_pretraining/sense_voice/outputs/sensevoice_finetune_v1")
